...
describe("test fundme contract", async function() {
    ...
    it ("window closed, value greater than minimum, fund failed",
        async function() {
            ...
            await expect(fundMe.fund({value: ethers.parseEther("0.1")})).to.be.revertedWith("window is closed") //wei
        }
    )
    ...
    it("window open, value is less than minimum, fund failed",
        async function() {
            // value is greater than minimum value
            await expect(fundMe.fund({value: ethers.parseEther("0.000001")})).to.be.revertedWith("Send more ETH") //wei 
    ...
    it("window open, value is greater than minimum, fund success",
        async function() {
            ...
            await expect(balance).to.equal(ethers.parseEther("0.00001"))
        }
    )
